...
class MainOverlay : public tsl::Overlay {
 public:
  ...
  virtual std::unique_ptr<tsl::Gui> loadInitialGui() override {
    ...
    std::array<u8, 8> supported_scarlet_build_id = { 0x42, 0x1c, 0x54, 0x11, 0xb4, 0x87, 0xeb, 0x4d };
    tryGameWithBuildId(MainSvView, csight::SupportedGame::Scarlet, supported_scarlet_build_id);

    std::array<u8, 8> supported_violet_build_id = { 0x70, 0x9b, 0xfd, 0x66, 0x11, 0x52, 0x98, 0x64 };
